# إعداد المنصات (Setup Platforms)

تغطي هذه الوثيقة كيفية إعداد الحزمة لمختلف منصات التواصل الاجتماعي.
...
يحتوي ملف `config/autopost.php` المنشور على جميع خيارات التكوين:
