...
Ce document explique comment configurer le package pour les différentes plateformes de médias sociaux.
...
Le fichier publié `config/autopost.php` contient toutes les options de configuration :
...
return [
    ...
    // ... autres configurations de plateformes
