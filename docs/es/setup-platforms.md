...
Este documento explica cómo configurar el paquete para diferentes plataformas de redes sociales.
...
El archivo publicado `config/autopost.php` contiene todas las opciones de configuración:
...
return [
    ...
    // ... otras configuraciones de plataformas
